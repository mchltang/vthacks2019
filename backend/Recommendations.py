...
# example function call for recommend
recommendations = recommend(title = "Sword Art Online", scoreThreshold = 8.5, isTV = True, isCompleted = True)
print(recommendations)

# example function call for sending all anime names in an array
animeNames = getAnimeNames()
print(animeNames)